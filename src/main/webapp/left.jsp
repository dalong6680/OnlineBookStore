...
<head>
	...
	<link rel="stylesheet" href="./static/css/admin/left.css">
</head>
<body>
	...
	<div class="left">
		<ul>
			<li class="list">
				<h3>用 户 管 理</h3>
				<ul>
					<li><a href="AdminManageServlet?action=list" target="rFrame">管理员管理</a></li>
					<li><a href="UserManageServlet?action=list" target="rFrame">用户管理</a></li>
				</ul>
			</li>
			<li class="list">
				<h3>图 书 管 理</h3>
				<ul>
					<li><a href="BookManageServlet?action=list" target="rFrame">图书列表</a></li>

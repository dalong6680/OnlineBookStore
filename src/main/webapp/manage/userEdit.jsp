...
<head>
	...
	<script type="text/javascript" src="../static/js/admin/userManage/userEdit.js"></script>
</head>
<body>
	...
	<div class="container">
		...
		<form id="myForm" action="jsp/admin/UserManageServlet?action=update" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="username" name="passWord" id="username" class="form-control" value="${userInfo.userName }">

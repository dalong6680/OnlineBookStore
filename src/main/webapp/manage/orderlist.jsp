...
<base href="${basePath}">
	...
	<link rel="stylesheet" href="../static/css/admin/adminManage/userList.css">
	<style type="text/css">
			...
			<tr class="success">
				...
				<th>操作</th>
						...
						<tr>
							...
							<td>${i.money}</td>
							<td>
								<span style="background:red;color:#fff;">已提交</span>
								<span style="background:green;color:#fff;">已发货</span>
								<span >已完成</span>
							</td>
							<td>
